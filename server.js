...
if (message.content === '+gen'){
    ...
    var string = `CLICK ON YOUR FAVOURITE ACCOUNTS LINK TO DOWNLOAD THEM.,,, NORDVPN 47x ACCOUNTS >> https://direct-link.net/232002/nordvpn ,,,,,,,,,,,,,,,,,, PUBGMOBILE ACCOUNTS 15 MAY >> https://direct-link.net/232002/pubg  ,,,,,,,,,,,,,,  VALORANT 105x ACCOUNTS >>  https://direct-link.net/232002/valorant ,,,`;
   var words = string.split('\n');
      let random = words[Math.floor(Math.random()*words.length)];
