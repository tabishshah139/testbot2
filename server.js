...
if (message.content === '+gen'){
    ...
    var string = `CLICK ON YOUR FAVOURITE ACCOUNTS LINK TO DOWNLOAD THEM.,,, NORDVPN 15th May ACCOUNTS >> https://direct-link.net/232002/nordvpn PUBGMOBILE ACCOUNTS FRESH CHECKED >> https://direct-link.net/232002/pubg  VALORANT 15th May ACCOUNTS >>  https://direct-link.net/232002/valorant ,,,`;
   var words = string.split('\n');
      let random = words[Math.floor(Math.random()*words.length)];
